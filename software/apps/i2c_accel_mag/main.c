...
int main(void) {
  ...
  app_timer_init();
  app_timer_create(&my_timer_1, APP_TIMER_MODE_REPEATED, temp_timer_callback);
  app_timer_start(my_timer_1, 32768, NULL);
  app_timer_create(&my_timer_2, APP_TIMER_MODE_REPEATED, accel_timer_callback);
  app_timer_start(my_timer_2, 32768, NULL);
  app_timer_create(&my_timer_3, APP_TIMER_MODE_REPEATED, mag_timer_callback);
